...
```
dependencies {
  implementation 'org.plumelib:reflection-util:1.1.2'
}
```

Other build systems are [similar](https://search.maven.org/artifact/org.plumelib/reflection-util/1.1.2/jar).
