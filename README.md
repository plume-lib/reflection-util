...
```
dependencies {
  implementation 'org.plumelib:reflection-util:1.1.1'
}
```

Other build systems are [similar](https://search.maven.org/artifact/org.plumelib/reflection-util/1.1.1/jar).
